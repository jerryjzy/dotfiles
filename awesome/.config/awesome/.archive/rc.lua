...
run_once("xmodmap /home/jerryjzy/.Xmodmap")
run_once("/home/jerryjzy/script/hdmi.sh")
-- }}}
...
pulsewidget = lain.widgets.pulsebar()
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "d", function ()
        awful.util.spawn(string.format("dmenu_run -i -fn 'terminus-18' -nb '%s' -nf '%s' -sb '%s' -sf '%s'",
